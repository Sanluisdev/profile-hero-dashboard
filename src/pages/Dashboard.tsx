              ...
              <CardContent>
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Cuenta creada: {currentUser.metadata.creationTime}</p>
                    <p className="text-xs text-gray-400">Último inicio: {currentUser.metadata.lastSignInTime}</p>
                    <p className="text-xs text-gray-400">ID: {currentUser.uid.substring(0, 8)}...</p>
                  </div>
